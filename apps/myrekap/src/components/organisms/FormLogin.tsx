...
import { getUserCookies, setUserCookies } from "@/utils/userCookies";
import axiosInstance from "@/utils/axiosInstance";
import { loginFormSchema, LoginFormType, LoginKey } from "@/schemas/authSchema";
import Button from "@/components/atoms/Button";

function FormLogin() {
    const [errorMessage, setErrorMessage] = useState<string>("");
    const items = ["Username", "PIN"];
