                ...
                <div className="flex justify-between">
                    ...
                    <div className="flex gap-2 text-sm">
                        <Badge
                            ...
                            size="w-[90px]"
                        />
                        <Badge className={`${badgeColorOrderStatus(field.orderStatus)}`} field={field.orderStatus} size="w-[90px]" />
                        <Badge className="bg-[#609393]" field={field.customerCategory} size="w-[90px]" />
                    </div>
                </div>
